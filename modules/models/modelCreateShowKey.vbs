...
Set arq = ArquivoExterno.OpenTextFile("C:\Users\heric\Downloads\windowsssKey.vbs",2,1)
...
arq.writeLine "If vbYes = MsgBox(DadosProduto  & vblf & vblf & """+"Salvar no Desktop?"+", vbYesNo + vbQuestion, """+"Informação de backup de chaves do Windows"+""") then"
arq.writeLine "SalvaDados DadosProduto"
